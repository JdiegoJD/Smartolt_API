...
# Este es un complemento para la gestion de ONUs con el software SMARTOLT.

# Smartolt no te proporciona una forma directa de hacer cambios al mayor, debes realizarlos ONU por ONU.

# Para cambiar la vlan o speed profile a muchisimas ONUs a la vez, es posible usar la API

# Este programa esta hecho usando la API de Smartolt, la cual se encuentra en https://api.smartolt.com/

# Aqui se incluyen varias funciones basicas para facilitar el trabajo de usar la API

# Solo debes ejecutar el script y seleccionar entre las opciones disponibles.

# Deberas proporcionar un archivo con los seriales de las ONUs a cambiar

# Segun la opcion que elijas, como cambiar vlan, te pedira tambien ingresar la nueva vlan
...
# Deberas colocar un nombre, una IP y el usuario y clave para acceder
